...
public class LocateProvider5 extends Capabilities{
	...
	Thread.sleep(1000);
	logger1.info("Locate a provider option '//*[@id=\"header-navbar-collapse\"]/div[2]/ul/li[5]/ul/li[2]/a' is clicked");
...
//	sel.selectByIndex(1);
	...
	Thread.sleep(1000);
	logger1.info("Provider name 'Fortis Hospital' is typed in textbox '//input[@class='ng-pristine ng-valid ng-empty ng-touched']' ");
	type("ProviderName_Xpath","ProviderName");
	
	Thread.sleep(1000);
	logger1.info("Practice Number '12345678' is typed in textbox '//input[@placeholder='Practice number'][@class='ng-pristine ng-valid ng-empty ng-touched']' ");
